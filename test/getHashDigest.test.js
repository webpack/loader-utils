...
describe("getHashDigest()", () => {
  [
    ...
    ["test string", "xxhash64", "base52", undefined, "rUymnmDGYfyb"],
    ...
    ["abc\\0💩", "xxhash64", "base52", undefined, "UIZJcQjyBfca"],
    ["abc\\0♥", "xxhash64", "base52", undefined, "dolLjQAyLdqa"],

    ["test string", "md4", "hex", 4, "2e06"],
    ["test string", "md4", "base64", undefined, "Lgbt1PFiMmjFpRcw2KCyrw=="],
    ["test string", "md4", "base52", undefined, "oufXqJmeetTZdHDsxKIqWge"],
    ...
    ["abc\\0💩", "md4", "base52", undefined, "DoPvebJkOxGXHYkEFNEZXtd"],
    ["abc\\0♥", "md4", "base52", undefined, "sHyaPlKHkuewVsGRXfcFFYf"],
    ...
    ["test string", "md5", "base52", undefined, "xQLGQBfgjcaUqtuASHdlnJd"],
    ["test string", "md5", "base64", undefined, "b421md6Yb6t6IWJbeRZYnA=="],
    ["test string", "md5", "base26", 6, "xgvbgg"],
    ...
    ["abc\\0💩", "md5", "base52", undefined, "xBfOnTchExqxUKUaHGWVhjd"],
    ["abc\\0♥", "md5", "base52", undefined, "cJzyapJUxzronOyReSsaeHe"],
