...
function interpolateName(loaderContext, name, options) {
	...
	if(loaderContextOptions !== null && typeof loaderContextOptions === "object" && typeof loaderContextOptions.customInterpolateName === "function") {
		url = loaderContextOptions.customInterpolateName.call(loaderContext, url, name, options);
	}
	return url;
}
